        ...
        <div class="w-[calc(100%-30px)] flex">
          <div class="w-[calc(100%-200px)] flex justify-center ">
            ...
            <form class="flex items-center w-[500px]">
              ...
              <div class="relative w-full">
                ...
                <router-link to="/search" class="flex absolute inset-y-0 right-0 items-center pr-3">
          ...
          <div class="w-[200px] ">
            <div class="flex items-center justify-start space-x-4 cursor-pointer" @click="toggleDrop">
              <img class="w-10 h-10 rounded-full border-2 border-gray-50" src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="">
              <div class="font-semibold text-gray-500 dark:text-gray-400 text-left">
                <div>Rizky </div>
